...
public enum UserErrorCode implements ErrorCode {
	...
	USER_INVALID_REGION_ADDRESS_MISMATCH(HttpStatus.CONFLICT, "주소에 선택한 지역 정보(시/도, 시/군/구)가 올바르게 포함되어 있지 않습니다."), 
	
	USER_SUSPEND_MODIFY_STATE(HttpStatus.CONFLICT, "대상 사용자를 정지시킬 수 있는 상태가 아닙니다."),
	
	USER_SUSPEND_NOT_MESSAGE(HttpStatus.CONFLICT, "정지사유가 필요합니다."),
	...
	USER_SIGNUP_REQUIRED_NOT_AGREED(HttpStatus.BAD_REQUEST, "필수 약관에 모두 동의해야 합니다."),
	;
