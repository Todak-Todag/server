...
import com.spring.careplanservice.careplan.infrastructure.persistence.repository.JpaCarePlanServicePreferenceRepository;
...
public class CarePlanServicePreferenceQueryRepositoryImpl implements CarePlanServicePreferenceQueryRepository {
    private final JpaCarePlanServicePreferenceRepository jpaCarePlanServicePreferenceRepository;

    @Override
    public Optional<CarePlanServicePreference> findById(UUID id) {
        return jpaCarePlanServicePreferenceRepository.findByIdAndDeletedAtIsNull(id);
    }
}
