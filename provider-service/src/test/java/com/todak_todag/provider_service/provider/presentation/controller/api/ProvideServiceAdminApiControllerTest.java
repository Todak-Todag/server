...
@WebMvcTest(ProvideServiceAdminApiController.class)
@DisplayName("서비스 종류 등록 API")
class ProvideServiceAdminApiControllerTest {

    private static final String BASE_URL = "/api/v1/admin/provide-services";
